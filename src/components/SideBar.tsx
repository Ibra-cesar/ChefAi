...
const SideBar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bg-white text-black w-64 h-screen p-5 overflow-y-auto z-40 duration-100
      ...
      >
        ...
        {loading ? (
          ...
          recipes.map((recipe) => (
            <div key={recipe.id} className="p-2 hover:bg-gray-700 rounded">
              {recipe.title}
            </div>
          ))
        )}
